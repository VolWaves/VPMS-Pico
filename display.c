...
// __inline void spi_write(const uint8_t* src, size_t len) {
...
void screen_init(void) {
	...
	spi_write_cmd(0x2A, 0x00, 0x00, 0x00, 0xF0);
	spi_write_cmd(0x2B, 0x00, 0x00, 0x00, 0xF0);

	spi_write_cmd(0xB2, 0x0C, 0x0C, 0x00, 0x33, 0x33);

	spi_write_cmd(0xB7, 0x35);
	spi_write_cmd(0xBB, 0x19);
	spi_write_cmd(0xC0, 0x2C);
	spi_write_cmd(0xC2, 0x01);
	spi_write_cmd(0xC3, 0x12);
